...
import { createBillingInformation } from "./graphql/mutations";
const client = generateClient();
export default function BillingInformationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMunicipality(initialValues.municipality);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBillingInformation.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BillingInformationCreateForm")}
      {...rest}
    >
      <TextField
        label="Identity card"
